    ...
    return(
        ...
        <nav className="flex space-x-8">
            ...
            <button
                ...
                className={`pb-4 px-1 font-medium text-sm ${activeTab === "about" ? "border-b-2 border-gray-800 text-gray-800" : "text-gray-500 hover:text-gray-700"} cursor-pointer whitespace-nowrap !rounded-button`}
            >
                About
            </button>
        </nav>
